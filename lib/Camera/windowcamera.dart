...
class WindowCamera extends StatefulWidget {
  /// Default Constructor
  const WindowCamera({super.key});

  @override
  State<WindowCamera> createState() => _WindowCameraState();
}

class _WindowCameraState extends State<WindowCamera> {
